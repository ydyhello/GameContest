...
const WebviewBridge = new class {
    ...
    onVKeyboardNumCb2: cb = null
    onVKeyboardNumCbObj2: cb = null

    onVKeyboardNumCb3: cb = null
    onVKeyboardNumCbObj3: cb = null

    onVKeyboardNumCb4: cb = null
    onVKeyboardNumCbObj4: cb = null
    constructor() {
    ...
    setVKeyboardNumCb2(f, o) {
        this.onVKeyboardNumCb2 = f;
        this.onVKeyboardNumCbObj2 = o;
    }

    setVKeyboardNumCb3(f, o) {
        this.onVKeyboardNumCb3 = f;
        this.onVKeyboardNumCbObj3 = o;
    }
    setVKeyboardNumCb4(f, o) {
        this.onVKeyboardNumCb4 = f;
        this.onVKeyboardNumCbObj4 = o;
    }
    ...
    getVKeyboardNum(num: number) {
        ...
        if (this.onVKeyboardNumCb2) {
            if (this.onVKeyboardNumCbObj2) {
                this.onVKeyboardNumCb2.call(this.onVKeyboardNumCbObj2, num);
            }
            else {
                this.onVKeyboardNumCb2(num);
            }
        }
        if (this.onVKeyboardNumCb3) {
            if (this.onVKeyboardNumCbObj3) {
                this.onVKeyboardNumCb3.call(this.onVKeyboardNumCbObj3, num);
            }
            else {
                this.onVKeyboardNumCb3(num);
            }
        }
        if (this.onVKeyboardNumCb4) {
            if (this.onVKeyboardNumCbObj4) {
                this.onVKeyboardNumCb4.call(this.onVKeyboardNumCbObj4, num);
            }
            else {
                this.onVKeyboardNumCb4(num);
            }
        }
    }
    /**退出游戏返回大厅的时候使用 */
